...
#define IS_MEM_GPIO(pin) ((pin) == MEM_GPIO_35 || (pin) == MEM_GPIO_36 || (pin) == MEM_GPIO_37)
...
#error "Forbidden GPIO assignment: GPIO35/36/37 are reserved for memory lines on this ESP32-S3 build"
#endif
