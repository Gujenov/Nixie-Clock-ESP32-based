...
#define FIRMWARE_VERSION "1.A0.3.260330"
...
#define AUDIO_I2S_BCLK_PIN 47   // I2S BCLK
#define AUDIO_I2S_LRCLK_PIN 48  // I2S WS/LRCLK
#define AUDIO_I2S_DOUT_PIN 0    // I2S DOUT (data to DAC)
